...
function default_1(project, task, aggreg_html_deps) {
    ...
    task("compile_target_scss_to_css", __spreadArray(__spreadArray([], file_list.templt_css), file_list.aggreg_css), [file_list.templt_scss, file_list.aggreg_scss, file_list.layout_scss, file_list.widget_scss], function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
